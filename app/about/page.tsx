  ...
  return (
    <div className="pt-24 pb-16">
      <div className="container px-4 mx-auto">
        ...
        >
          <h1 className="text-3xl md:text-5xl font-bold mb-4">عن كلية التربية</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
          ...
          >
            <h2 className="text-2xl font-bold mb-4">كلمة العميدة</h2>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {collegeInfo.strategicGoals.map((goal, index) => (
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="text-center">
                    <div className="mx-auto w-32 h-32 rounded-full overflow-hidden mb-4">
                      <Image
                        src="https://hr.mans.edu.eg/dpp/2740709/11/00201/00.jpg"
                    ...
                    <h3 className="font-bold text-lg">أ.د. نشوى رفعت محمد شحاته</h3>
                  ...
                  <div className="text-center">
                    <div className="mx-auto w-32 h-32 rounded-full overflow-hidden mb-4">
                      <Image
                        src="https://hr.mans.edu.eg/dpp/2771203/11/00684/00.jpg"
                    ...
                    <h3 className="font-bold text-lg">أ.د. رانيا وصفى عثمان عثمان غنيم</h3>
