...
import { getCourseImage } from "@/lib/getImages";
...
export default function Home() {
  ...
  const [searchType, setSearchType] = useState<
    "all" | "professors" | "courses"
  >("all");
  const [selectedDepartment, setSelectedDepartment] = useState("all");
  const [selectedProfessor, setSelectedProfessor] = useState<Professor | null>(
    null,
  );
  const [selectedCourse, setSelectedCourse] = useState<FlattenedCourse | null>(
    null,
  );
  ...
  useEffect(() => {
    ...
    Object.entries(coursesData).forEach(([level, semesters]) => {
      Object.entries(semesters as Record<string, any>).forEach(
        ([semester, courses]) => {
  ...
  const filteredProfessors = professors.filter((professor) => {
    ...
    if (selectedDepartment === "all") {
      ...
      matchesDepartment =
        ...
        professor.department.includes(selectedDepartment);
    }
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container px-4 mx-auto">
          ...
          {searchTerm && (
            <div className="max-w-6xl mx-auto mb-12">
                      ...
                      <Card className="overflow-hidden h-full bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border border-white/20 shadow-lg rounded-2xl transition-all duration-300 hover:shadow-xl">
                        <CardContent className="p-0">
                          <div className="relative w-full pt-[100%] overflow-hidden">
                            ...
                            <Badge className="absolute top-3 left-3 bg-blue-500/90">
                              عضو هيئة تدريس
                            </Badge>
                          </div>
                      ...
                      <Card className="overflow-hidden h-full bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border border-white/20 shadow-lg rounded-2xl transition-all duration-300 hover:shadow-xl">
                        <CardContent className="p-0">
                          <div className="relative w-full pt-[60%] overflow-hidden">
                            ...
                            <Badge className="absolute top-3 left-3 bg-emerald-500/90">
                              مقرر دراسي
                            </Badge>
                          </div>
                          <div className="p-5 relative">
              ...
              {searchResults.length === 0 && (
                <div className="text-center pt-16 glass-card rounded-2xl max-w-md mx-auto mt-8 border border-white/20 backdrop-blur-md">
                ...
                <div className="flex flex-col md:flex-row justify-between">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {selectedProfessor?.department || "بدون قسم"}
                    </p>
                  </div>
            ...
            <DialogContent className="max-w-2xl rounded-2xl bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border border-white/20 p-0 overflow-hidden">
              <div className="relative h-32 md:h-32 w-full overflow-hidden">
                ...
                <div className="absolute bottom-4 right-4 max-w-[80%]">
                  <h2 className="text-2xl font-bold text-white drop-shadow-md bg-black/60 px-2 py-2 rounded-lg">
              ...
              <div className="p-8">
                ...
                <div className="flex justify-end mt-6">
                  <Button className="rounded-xl">
                    <Link
                      href={`/courses?level=${selectedCourse?.level}&semester=${selectedCourse?.semester}`}
                    >
      ...
      <SectionTitle
            title="كلية التربية"
            description="تضم كلية التربية مجموعة متنوعة من الأقسام الأكاديمية التي تغطي مختلف مجالات التربية والتعليم"
          />
        <div className="container px-4 mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <Dialog open={videoOpen} onOpenChange={setVideoOpen}>
              <DialogContent className="max-w-4xl p-1 sm:p-2 rounded-2xl bg-white/90 dark:bg-gray-900/90 backdrop-blur-md">
                <VideoPlayer url="/videos/main.mp4" />
              </DialogContent>
            </Dialog>
        ...
        <div className="container px-4 mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              تضم كلية التربية مجموعة متنوعة من الأقسام الأكاديمية التي تغطي
              مختلف مجالات التربية والتعليم
            </p>
          </div>
